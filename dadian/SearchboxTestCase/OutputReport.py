...
def writeToHtml():
    # fileIsExist('Report/')
    reportPath = "Report/report_feed.html"
...
def dataParser(logpath, pointType, point_rules, durationpath,dict_total_points):
    global realcontent
    global jsoncontent
    global scriptcontent
    ...
    statisticsPoints(dict_total_points)

def statisticsPoints(dict_total_points):
